...
namespace TestBL
{
    ...
    public class PromoServiceUnitTest
    {
        ...
        public void TestGetPromoByIdUserDefault()
        {
            ...
            Promo promo = CreatePromo(promos.Count + 1);
            int promoId = promos.Count + 1;
        ...
        private List<UserPromo> CreateMockUserPromo(List<User> users, List<Promo> promos)
        {
            ...
            {
                new UserPromo(1, users[0].Id, promos[0].Id),
                new UserPromo(2, users[1].Id, promos[1].Id),
                new UserPromo(3, users[2].Id, promos[2].Id)
            };
        }
        private Promo CreatePromo(int promoId)
        {
