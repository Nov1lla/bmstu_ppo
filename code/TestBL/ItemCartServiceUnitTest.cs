...
namespace TestBL
{
    ...
    public class ItemCartServiceUnitTest
    {
        ...
        public void TestAddItemCartDefault()
        {
            ...
            var itemCart = CreateItemCart(Guid.NewGuid());
        ...
        {
            new Cart(Guid.NewGuid(),"21/11/2023",  users[0].Id),
            new Cart(Guid.NewGuid(), "11/10/2021", users[1].Id),
            new Cart(Guid.NewGuid(), "23/12/2022", users[2].Id)};
        }
        ...
        private ItemCart CreateItemCart(Guid itemCartId)
        {
            return new ItemCart(itemCartId, Guid.NewGuid(), Guid.NewGuid(), 10);
        }
        ...
        {
            new ItemCart(Guid.NewGuid(), products[0].Id, carts[0].Id, 10),
            new ItemCart(Guid.NewGuid(), products[1].Id, carts[1].Id, 11),
            new ItemCart(Guid.NewGuid(), products[2].Id, carts[2].Id, 12)};
        }
    }
}